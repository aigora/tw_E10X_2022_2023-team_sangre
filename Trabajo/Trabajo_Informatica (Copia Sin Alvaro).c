...
/*Funciones Álvaro*/
 ...
 void Op_Ficheros_Anios( int anio_1, int anio_2);
    ...
    switch (eleccion_comparacion) /* Switch para la Eleccion de Datos a Comparar (Meses | Anios)*/
    {
        case 'a': // Parte de Alvaro//
        {
        	int anio1, anio2;
             ...
             do {
             	printf("Nuestra base de datos contiene datos por anio desde el periodo del 2007 hasta el 2023. Recuerde elegir un anio en ese intervalo.\n\n");
             ...
             do {
                ...
                printf("Ha elegido comparar los datos de los anios %d y %d.\nA continuacion observara el dato individual anual de cada uno y posteriormente la diferencia", anio1, anio2);
...
void Op_Ficheros_Anios(int anio_1, int anio_2) {
    ...
    sprintf(ruta1, "C:\\Users\\user2\\Desktop\\FicherosAnios\\%d.txt", anio_1);
    sprintf(ruta2, "C:\\Users\\user2\\Desktop\\FicherosAnios\\%d.txt", anio_2);
