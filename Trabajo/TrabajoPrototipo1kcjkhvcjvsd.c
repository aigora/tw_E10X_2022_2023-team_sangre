...
int f_comparacion_eleccion_mes (int comparacion_eleccion_mes_int) // Funcion Seleccion de Meses a Comparar // // Sin Errores //
{
...
void f_comparacion_ficheros (int anio_mes_void, int mes_void, int *hidraulica_0, int *hidraulica_1, int *eolica_0, int *eolica_1, int *solar_fotovoltaica_0, int *solar_fotovoltaica_1, int *solar_termica_0, int *solar_termica_1, int *otras_renovables_0, int *otras_renovables_1, int *residuos_renovables_0, int *residuos_renovables_1, int *Generacion_Renovable_0, int *Generacion_Renovable_1, int *turbinacion_bombeo_0, int *turbinacion_bombeo_1, int *nuclear_0, int *nuclear_1, int *ciclo_combinado_0, int *ciclo_combinado_1, int *carbon_0, int *carbon_1, int *cogeneracion_0, int *cogeneracion_1, int *residuos_no_renovables_0, int *residuos_no_renovables_1, int *Generacion_No_Renovable_0, int *Generacion_No_Renovable_1, int *consumos_en_bombeo_0, int *consumos_en_bombeo_1, int *enlace_peninsula_baleares_0, int *enlace_peninsula_baleares_1, int *saldo_intercambios_internacionales_0, int *saldo_intercambios_internacionales_1, int *Demanda_0, int *Demanda_1)
{
    ...
    if (anio_mes_void == 2020)
    {
        if (mes_void == 1)
        {
            ...
            plectura_2020_enero = fopen("FICHEROS/2020_enero.csv", "r");
        ...
        if (mes_void == 2)
        {
            ...
            plectura_2020_febrero = fopen("FICHEROS/2020_febrero.csv", "r");
        ...
        if (mes_void == 3)
        {
            ...
            plectura_2020_marzo = fopen("FICHEROS/2020_marzo.csv", "r");
        ...
        if (mes_void == 4)
        {
            ...
            plectura_2020_abril = fopen("FICHEROS/2020_abril.csv.txt", "r");
        ...
        if (mes_void == 5)
        {
            ...
            plectura_2020_mayo= fopen("FICHEROS/2020_mayo.csv", "r");
        ...
        if (mes_void == 6)
        {
            ...
            plectura_2020_junio = fopen("FICHEROS/2020_junio.csv", "r");
        ...
        if (mes_void == 7)
        {
            ...
            plectura_2020_julio = fopen("FICHEROS/2020_julio.csv", "r");
        ...
        if (mes_void == 8)
        {
            ...
            plectura_2020_agosto = fopen("FICHEROS/2020_agosto.csv", "r");
        ...
        if (mes_void == 9)
        {
            ...
            plectura_2020_septiembre = fopen("FICHEROS/2020_septiembre.csv", "r");
        ...
        if (mes_void == 10)
        {
            ...
            plectura_2020_octubre = fopen("FICHEROS/2020_octubre.csv", "r");
        ...
        if (mes_void == 11)
        {
            ...
            plectura_2020_noviembre = fopen("FICHEROS/2020_noviembre.csv", "r");
        ...
        if (mes_void == 12)
        {
            ...
            plectura_2020_diciembre = fopen("FICHEROS/2020_diciembre.csv", "r");
    ...
    if (anio_mes_void == 2021)
    {
        if (mes_void == 1)
        {
            ...
            plectura_2021_enero = fopen("FICHEROS/2021_enero.csv", "r");
        ...
        if (mes_void == 2)
        {
            ...
            plectura_2021_febrero = fopen("FICHEROS/2021_febrero.csv", "r");
        ...
        if (mes_void == 3)
        {
            ...
            plectura_2021_marzo = fopen("FICHEROS/2021_marzo.csv", "r");
        ...
        if (mes_void == 4)
        {
            ...
            plectura_2021_abril = fopen("FICHEROS/2021_abril.csv", "r");
        ...
        if (mes_void == 5)
        {
            ...
            plectura_2021_mayo= fopen("FICHEROS/2021_mayo.csv", "r");
        ...
        if (mes_void == 6)
        {
            ...
            plectura_2021_junio = fopen("FICHEROS/2021_junio.csv", "r");
        ...
        if (mes_void == 7)
        {
            ...
            plectura_2021_julio = fopen("FICHEROS/2021_julio.csv", "r");
        ...
        if (mes_void == 8)
        {
            ...
            plectura_2021_agosto = fopen("FICHEROS/2021_agosto.csv", "r");
        ...
        if (mes_void == 9)
        {
            ...
            plectura_2021_septiembre = fopen("FICHEROS/2021_septiembre.csv", "r");
        ...
        if (mes_void == 10)
        {
            ...
            plectura_2021_octubre = fopen("FICHEROS/2021_octubre.csv", "r");
        ...
        if (mes_void == 11)
        {
            ...
            plectura_2021_noviembre = fopen("FICHEROS/2021_noviembre.csv", "r");
        ...
        if (mes_void == 12)
        {
            ...
            plectura_2021_diciembre = fopen("FICHEROS/2021_diciembre.csv", "r");
    ...
    if (anio_mes_void == 2022)
    {
        if (mes_void == 1)
        {
            ...
            plectura_2022_enero = fopen("FICHEROS/2022_enero.csv", "r");
        ...
        if (mes_void == 2)
        {
            ...
            plectura_2022_febrero = fopen("FICHEROS/2022_febrero.csv", "r");
        ...
        if (mes_void == 3)
        {
            ...
            plectura_2022_marzo = fopen("FICHEROS/2022_marzo.csv", "r");
        ...
        if (mes_void == 4)
        {
            ...
            plectura_2022_abril = fopen("FICHEROS/2022_abril.csv", "r");
        ...
        if (mes_void == 6)
        {
            ...
            plectura_2022_junio = fopen("FICHEROS/2022_junio.csv", "r");
        ...
        if (mes_void == 7)
        {
            ...
            plectura_2022_julio = fopen("FICHEROS/2022_julio.csv", "r");
        ...
        if (mes_void == 8)
        {
            ...
            plectura_2022_agosto = fopen("FICHEROS/2022_agosto.csv", "r");
        ...
        if (mes_void == 9)
        {
            ...
            plectura_2022_septiembre = fopen("FICHEROS/2022_septiembre.csv", "r");
        ...
        if (mes_void == 10)
        {
            ...
            plectura_2022_octubre = fopen("FICHEROS/2022_octubre.csv", "r");
        ...
        if (mes_void == 11)
        {
            ...
            plectura_2022_noviembre = fopen("FICHEROS/2022_noviembre.csv", "r");
        ...
        if (mes_void == 12)
        {
            ...
            plectura_2022_diciembre = fopen("FICHEROS/2022_diciembre.csv", "r");
